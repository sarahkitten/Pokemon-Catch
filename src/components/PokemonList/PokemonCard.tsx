...
export function PokemonCard({ pokemon, pokemonData, isMuted, isRevealed }: PokemonCardProps) {
  return (
    <div
      className={`pokemon-card nes-container is-rounded ${isRevealed ? 'uncaught' : ''}`}
